    ...
    methods: {
        ...
        getProducts() {
            ...
            document.querySelectorAll('.BChoiseCard').forEach(function (el, id) {
                ...
                el.setAttribute('v-bind:id', 'product' + id);
                el.querySelector('.BCAdd').setAttribute('v-on:click.prevent', `say('hi')`);
                el.querySelector('.BCAdd').setAttribute(`v-on:click`, `this.$refs.cart.addProduct`);
...
/*function getProducts() {
    ...
    document.querySelectorAll('.BChoiseCard').forEach(function (el, id) {
        ...
        let regExp = new RegExp(/[\d\.]+/, 'g');
        let price = el.querySelector('.BChoisePrice').innerText.match(regExp)[0];
        products.push(new Catalog(id, name, price));
    })
    //Object.assign(products)
    return products;
}*/

/*app.postJson('/api/products', app.getProducts())
    .then(data => {
        console.log(data);
    });*/
// class List {
